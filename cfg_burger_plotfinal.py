# CSC_ASSIGNMENT 2 - CFD - ROBIN LIN
...
def evolve(u, v, dx, dy, dt, nozzle_u, nozzle_v, nx, ny, nu, steps):
...
(final_u, final_v) = evolve(initial_u, initial_v, dx, dy, dt, nozzle_u, nozzle_v, nx, ny, nu, nt)
...
cmap=pyplot.cm.jet)
ax.savefig('frame'+str(2510).zfill(5)+'.png',dpi=300)
ax.clear()
